...
<html lang="en">
  <head>
    <title>حضانة الصفا والمروة</title>
    <meta charset="utf-8">
  ...
  <body>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
			    		<div class="col-md-5 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">شارع الجبانة /قصر نصر الدين</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-secondary mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">rabie3500@gmail.com</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-tertiary mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <span class="text">01061154247</span>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark ftco_navbar ftco-navbar-light " id="ftco-navbar">
	    <div class="container d-flex align-items-right">
	    	<a class="navbar-brand" href="index"><h3> حضانة الصفا والمروة</h3></a>
